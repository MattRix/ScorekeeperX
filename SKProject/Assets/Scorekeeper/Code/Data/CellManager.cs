...
public class CellManager
{
	...
	public static Cell megaVolume = new Cell();
...
//	public static Cell megaSettings = new Cell();
	...
	static void SetupMegaCells ()
	{
		...
		megaReset.SetSize(fullWidth,halfHeight);
		megaReset.SetPosition(-Config.HALF_WIDTH + megaReset.width/2 + padding,-Config.HALF_HEIGHT+megaReset.height/2+padding);
